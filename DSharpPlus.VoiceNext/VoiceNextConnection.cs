...
namespace DSharpPlus.VoiceNext
{
    ...
    public sealed class VoiceNextConnection : IDisposable
    {
        ...
        private BlockingCollection<VoicePacket> PacketQueue { get; }
        ...
        public bool IsPlaying
            => this.TransmitStream?.IsPlaying ?? false || this.PlayingWait != null && !this.PlayingWait.Task.IsCompleted;
        ...
        private async Task VoiceSenderTask()
        {
            ...
            while (!token.IsCancellationRequested)
            {
                ...
                var hasPacket = queue.TryTake(out var packet);
